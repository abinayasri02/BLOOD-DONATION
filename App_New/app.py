...
# It will pull your API key from the Render Vault!
...
def send_request_sms(donor_phone, patient_data, contact_data):
    ...
    # We keep the SMS short and punchy so it fits in one text message!
    sms_body = (
    ...
    querystring = {
        ...
        "message": sms_body,
        "language": "english",
        "route": "q", # 'q' stands for quick transactional route
        "numbers": donor_phone
    }
...
def request_donor(donor_id):
    ...
    if request.method == 'POST':
        ...
        # This triggers the SMS function with the form data!
